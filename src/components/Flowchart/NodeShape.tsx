...
function nodeClass(type: string): string {
  switch (type) {
    case "start":
    case "end":
      return "fill-chart-node-bg stroke-chart-node-border";
    case "decision":
      return "fill-chart-node-bg stroke-chart-node-border";
    case "io":
      return "fill-chart-node-bg stroke-chart-node-border";
...
export function NodeShape({ node, focused, onDoubleClick }: NodeShapeProps) {
  ...
  const shapeEl = (() => {
    switch (shape) {
      case "rounded-rect":
        return <RoundedRect w={w} h={h} className={cls} />;
      case "diamond":
        return <Diamond w={w} h={h} className={cls} />;
      case "parallelogram":
        return <Parallelogram w={w} h={h} className={cls} />;
      case "hexagon":
        return <Hexagon w={w} h={h} className={cls} />;
      case "subroutine":
        return <Subroutine w={w} h={h} className={cls} />;
      case "cylinder":
        return <Cylinder w={w} h={h} className={cls} />;
      case "double-circle":
        return <DoubleCircle w={w} h={h} className={cls} />;
      case "flag":
        return <Flag w={w} h={h} className={cls} />;
      case "stadium":
        return <Stadium w={w} h={h} className={cls} />;
      default:
        return <Rect w={w} h={h} className={cls} />;
    }
  })();
