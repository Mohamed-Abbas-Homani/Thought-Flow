...
const { theme, colorMode, customThemes, chartThemeTokens } =
...
function App() {
  ...
  const { tabs, activeTabPath, renameNode, renameEdge, renameTitle } =
    useTabStore();
  ...
  function handleRenameEdge(
    ...
    if (activeTabPath)
      renameEdge(activeTabPath, from, to, currentLabel, newLabel);
  }
